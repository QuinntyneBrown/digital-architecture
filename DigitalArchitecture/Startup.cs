...
namespace DigitalArchitecture
{
    public class Startup
    {
        ...
        public void InitLogging(IUnityContainer container)
        {
        ...
        public ILogger CreateLogger (ITraceConfiguration settings, string fileName = null, string tableName = null, ICollection<DataColumn> additionalColumns = null, bool? logToFile = null, bool? logToSql = null)
        {
